...
/* Estado ubicacion */
app.post('/estadoUbicacion', (req, res) => {
    let per = new mantenimientosSSMA_1.default();
    let params = req.body;
    per.estadoUbicacion(params).then((respuesta) => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield respuesta;
        if (!result.hasError) {
            return res.status(200).send(respuesta);
        }
...
/* Catálogo Extintores */
app.get('/catalogoExt', (req, res) => {
    let per = new mantenimientosSSMA_1.default();
    let params = req.query;
    per.catalogo(params).then((respuesta) => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield respuesta;
        if (!result.hasError) {
            return res.status(200).send(respuesta);
        }
