...
const motoristasController_1 = __importDefault(require("../../controllers/Transporte/motoristasController"));
...
app.get('/motoristas', (req, res) => {
    ...
    let params = req.body;
    mot.verMotoristas(params).then((respuesta) => __awaiter(void 0, void 0, void 0, function* () {
...
app.post('/EstadoCamiones', (req, res) => {
    let mot = new motoristasController_1.default();
    let params = req.body;
    mot.cambiarEstadoMotorista(params).then((respuesta) => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield respuesta;
        if (!result.hasError) {
            return res.status(200).send(respuesta);
        }
