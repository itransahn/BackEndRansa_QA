       ...
       <tr>
           <td style="background-color: white;">
               <div style="color: #34495e; text-align: justify;font-family: sans-serif; text-align: center;">
                   ...
                   <h2 style="color: #006F1D;"> Recibo ${data === null || data === void 0 ? void 0 : data.recibo} </h2>
               ...
               <p style="margin: 2px; font-size: 15px; color: #00A72C !important; text-align:  center;"> 
                ...
                <p style="margin: 3px; font-size: 15px; color: #00A72C !important; text-align:  center;"> 
                    Fecha/Hora del viaje <br> ${data === null || data === void 0 ? void 0 : data.FechaHora} </p>
                <p style="margin: 3px; font-size: 15px; color: #00A72C !important; text-align:  center;"> 
                        Contacto <br> (+504) ${data === null || data === void 0 ? void 0 : data.numero} </p>
                        <p style="margin: 3px; font-size: 15px; color: #00A72C !important; text-align:  center;"> 
                        Valor <br> ${data === null || data === void 0 ? void 0 : data.valor} </p>
